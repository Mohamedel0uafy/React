...
function App() {
  ...
  const handleCalculate = () => {
    ...
    if (steps < 5000) {
      level = "Peu actif 🧘‍♂️";
      img = "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExeWIybDM5Zmg0MDZ4bGF3cXl0cnpoMTN2eGVhY3A2MGpsaWpjcThyOCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/8PsTsGXP1QB3LihxTB/giphy.gif"; 
    } else if (steps < 10000) {
      level = "Actif 🚶‍♂️";
      img = "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExczZieDRrOTd0bDIwc3VjaHY5YnJ3OWxjZHRmeTNjZ3Z3aG9nZzR5NyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/vgUFOWBwBkziE/giphy.gif"; 
    } else {
      level = "Très actif 🏃‍♂️";
      img = "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExbTN2a2x4dTE5eGVoZ3BoYTQ1MW02bW03c29kdnZ6YmhmcWcyemhzMyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/CAYVZA5NRb529kKQUc/giphy.gif"; 
    }
